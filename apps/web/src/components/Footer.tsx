    ...
    <footer className="mt-24 border-t border-line bg-parchment/50">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-12 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <img src="/img/reliques/logo.png" alt={t("appName")} className="h-9 w-auto" />
          <span className="text-[10px] font-medium uppercase tracking-wider text-ink-soft">{t("studio")}</span>
        </div>
